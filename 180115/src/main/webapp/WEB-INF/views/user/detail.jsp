			...
			<form action="edit/${bean.no }">
				...
				<div class="col-md-12">
					<div class="form-group"> 
						...
						<textarea class="form-control" rows="20" name="content" id="content" readonly="readonly">
							${bean.content }
						</textarea>  
					</div> 
				</div>
				<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<a class="btn btn-default" id="del" data-method="delete" href="/major/detail/delete/${bean.no}">삭제</button>
					</div>
